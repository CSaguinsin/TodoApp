...
<body>
    <nav
  class="block w-full max-w-screen-xl px-6 py-3 mx-auto  border shadow-md rounded-xl border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200">
